...
const MyPackage: FC <MyPackageProps> = ({
    ...
    return (
        <div className="w-full h-auto bg-[#F9F9F9] rounded-[22px] px-7 py-10 flex">
            <div className="w-8/12 rounded-[22px] p-7 bg-[#FFF] mr-3">
                ...
                <div className='mt-3 grid grid-flow-row-dense grid-cols-2 gap-5'>
                    {
                        packageDemoCardList.map((el: any) => (
                            <PackageDemoCard 
                                type={el.type} 
                                title={el.title} 
