            ...
            type == 'learn' && (
                    <section className="relative w-full h-[278px]">
                        <article className="absolute w-full h-auto top-0 left-0 rounded-[22px]">
                            ...
                            {/* Course title */}
                            <h2 className="absolute top-[21px] left-[70px] font-bold text-[#101828] text-sm leading-[25px] whitespace-nowrap w-[50%] truncate">
                                {title}
                            </h2>
                    ...
                    <section className="relative w-full h-[278px]">
                        <article className="absolute w-full h-auto top-0 left-0 rounded-[22px]">
                            ...
                            <div className="absolute w-6 h-[25px] top-[21px] left-[30px] rounded-[18px] bg-m-main-color">
                                <Image src={wm_mark} alt={'wm_mark'} className='w-full h-full transform rotate-180' />
                            </div>
