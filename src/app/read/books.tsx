            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-10 sm:mx-16 mt-6 sm:mt-24">
              <div className='relative h-full min-h-[400px]'>
                ...
                <div className="flex flex-row mt-8 ml-4 absolute bottom-10">
                  <span>
                    <DefaultButton buttonColor="white" className="!text-text-color !py-2 !sm-py-2 border-2 border-gray-800">AAA</DefaultButton>
                  </span>
                  <span>
                    <DefaultButton className="ml-8 !py-2 !sm-py-2">BBB</DefaultButton>
                  </span>
                </div>
              </div>
          ...
          data.eCheatSheets && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-10 sm:mx-16 mt-6 sm:mt-24">
              <div className='relative h-full min-h-[400px]'>
                ...
                <div className="text-lg sm:text-4xl leading-11 font-bold mt-6 sm:mt-10 text-text-color">
                  Free eCheatSheets Resources
                </div>
                <p className='text-text-color mt-5 text-[15px] sm:text-[20px]'>
                    "Click Below To Download Your FREE Resources...
                    THE AI VALUE SHORTCUT by Edosa Odaro45 AI & Data Investment Critical Questions for Senior Leaders by Edosa OdaroC-Suite Data Value by Edosa OdaroThe Data & AI Value Wheel (FINANCIAL focus) by Edosa OdaroBAD vs GOOD Data & AI Design by Edosa OdaroTHE AI & DATA VALUE LITERATE C-SUITE by Edosa OdaroThe Anatomy of a Value-Driven Data CultureA Path to Data VALUE Literacy by Edosa Odaro
                    Get Your Data & AI Value Driven Score...
                    THE AI VALUE SH"  
                </p>
                <div className="flex flex-row mt-8 ml-4 absolute bottom-10">
                  <span onClick={() => window.open('https://www.edosaodaro.com/cheatsheets-resources/')}>
                    <DefaultButton buttonColor="white" className="!text-text-color !py-2 !sm-py-2 border-2 border-gray-800">Get it Here</DefaultButton>
                  </span>
                  <span onClick={() => window.open('https://www.edosaodaro.com/cheatsheets-resources/')}>
                    <DefaultButton className="ml-8 !py-2 !sm-py-2">Find Out More</DefaultButton>
              ...
              <div>
                <Image src={BOOK5} alt="learn image" className="sm:pt-0 pt-4 w-full rounded-2xl" />
              </div>
            </div>
          )
        }
