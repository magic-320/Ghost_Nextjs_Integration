                            ...
                            <div>
                                <div className='flex p-5 my-3 rounded-[10px] bg-[#eee] text-text-color'>
                                    <div className='w-11/12 text-[18px]'>
                                        <i className='text-l-main-color'>Course1</i>&nbsp;&nbsp;&nbsp; $Million AI Value Advisor - 12 Steps Kickstarting Your Journey
                                    </div>
                                ...
                                <div className='flex p-5 my-3 rounded-[10px] bg-[#eee] text-text-color'>
                                    <div className='w-11/12 text-[18px]'>
                                        <i className='text-l-main-color'>Course2</i>&nbsp;&nbsp;&nbsp; Demystifying & Accelerating AI Value
                                    </div>
                                    <div className='w-1/12 text-center'>
                                        <label className="inline-flex items-center cursor-pointer">
